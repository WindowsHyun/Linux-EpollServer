...
class mailer {
    public function sendMail($email, $subject, $message)
    {
        ...
        require($_SERVER['DOCUMENT_ROOT'].'/util/PHPMailer/src/PHPMailer.php');
        require($_SERVER['DOCUMENT_ROOT'].'/util/PHPMailer/src/SMTP.php');
        require($_SERVER['DOCUMENT_ROOT'].'/util/PHPMailer/src/Exception.php');
